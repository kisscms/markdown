...
class Page extends Model {
	...
	function retrieve( $id ) {
		...
		if( empty($this->rs['markdown']) ) $this->rs['markdown'] = $this->rs['content'];
		return $this->rs;
	}
	...
	function create() {
		...
		$this->rs['markdown'] = $this->rs['content'];
		$this->rs['content'] = MarkdownExtra::defaultTransform( $this->rs['markdown'] );
	...
	// this method is an exact copy from the base Page.php (extract in Model?)
